...
Понять, что такое 2D-лидар и сообщение **LaserScan**, как данные лидара попадают в Nav2 (costmap, AMCL, SLAM) и какой tf-фрейм для этого обязателен. Отдельно разберём **лидарную одометрию** как альтернативу колёсной. После статьи вы сможете подключить 2D-лидар к своему роботу и проверить, что Nav2 его «видит».
...
![Принцип работы 2D-лидара](images/lidar_scan_principle.jpg)
