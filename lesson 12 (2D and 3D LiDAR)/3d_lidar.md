...
Понять, чем 3D-лидар отличается от 2D, что такое сообщение **PointCloud2**, когда 3D действительно нужен и как подключить его к Nav2 — двумя способами. Отдельно разберём **3D-лидарную одометрию**.
...
![2D- и 3D-лидар](images/lidar_2d_vs_3d.jpg)
...
![3D-одометрия: регистрация облаков точек](images/lidar_3d_odometry.gif)
